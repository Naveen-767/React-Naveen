...
//       <div
//         className="text-5xl mb-3 drop-shadow-sm transition-transform duration-300 group-hover:-translate-y-1"
//         style={{ color: skill.color }}
//       >
//         {skill.icon}
//       </div>
...
const SkillCard: React.FC<{ skill: SkillType }> = ({ skill }) => {
  ...
  return (
    ...
    >
      <div
        className="text-5xl mb-3 transition-transform duration-300 group-hover:-translate-y-1"
        style={{ color: skill.color }}
      >
        <Icon size={48} />
      </div>
